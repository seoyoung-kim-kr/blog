...
export default function ContactCTA() {
  return (
    <section className="p-8 sm:p-10 rounded-3xl bg-linear-to-r from-[#ADC2A9]/30 via-white/90 to-[#FFC7C7]/30 dark:from-[#1E271D] dark:via-[#171E16] dark:to-[#241E20] border border-[#ADC2A9]/40 dark:border-[#ADC2A9]/20 shadow-md flex flex-col sm:flex-row items-center justify-between gap-6">
